...
Suyven v1 is the **retrieval and ranking engine**. It handles ingestion, embedding, search, reranking, and LLM response generation. The frontend application lives in a separate project and will consume this engine.

---

## Short Term

- **Connect frontend application** to the Suyven RAG backend (API layer between frontend and retrieval engine)
